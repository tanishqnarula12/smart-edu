...
export const NAVIGATION = {
  student: [
    ...
    { to: '/student/quizzes', label: 'Quizzes', icon: FlaskConical },
  ...
  teacher: [
    ...
    { to: '/teacher/quizzes', label: 'Quiz Library', icon: FlaskConical },
    { to: '/teacher/quiz-progress', label: 'Quiz Progress', icon: ClipboardCheck },
